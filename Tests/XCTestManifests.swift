...
extension RulesTests {
    ...
    static let __allTests__RulesTests = [
        ...
        ("testConditionsWrapAutoForLongGuard", testConditionsWrapAutoForLongGuard),
        ("testConditionsWrapAutoForLongGuardWithoutChanges", testConditionsWrapAutoForLongGuardWithoutChanges),
        ("testConditionsWrapAutoForMultilineGuard", testConditionsWrapAutoForMultilineGuard),
        ("testConditionsWrapAutoOptionForGuardInMethod", testConditionsWrapAutoOptionForGuardInMethod),
        ("testConditionsWrapAutoOptionForGuardStyledAsBeforeArgument", testConditionsWrapAutoOptionForGuardStyledAsBeforeArgument),
        ("testConditionsWrapAutoOptionForGuardWhenElseOnNewLine", testConditionsWrapAutoOptionForGuardWhenElseOnNewLine),
        ("testConditionsWrapAutoOptionForGuardWhenElseOnNewLineAndNotAligned", testConditionsWrapAutoOptionForGuardWhenElseOnNewLineAndNotAligned),
        ("testConditionsWrapAutoOptionForIfInsideMethod", testConditionsWrapAutoOptionForIfInsideMethod),
        ("testConditionsWrapAutoOptionForLongIf", testConditionsWrapAutoOptionForLongIf),
        ("testConditionsWrapAutoOptionForLongMultilineIf", testConditionsWrapAutoOptionForLongMultilineIf),
        ("testConditionWrapAlwaysOptionForLongGuard", testConditionWrapAlwaysOptionForLongGuard),
