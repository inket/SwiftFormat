...
extension RulesTests {
    ...
    static let __allTests__RulesTests = [
        ...
        ("testConditionWrapAutoForGuardWhenElseOnNewLine", testConditionWrapAutoForGuardWhenElseOnNewLine),
        ("testConditionWrapAutoForLongGuard", testConditionWrapAutoForLongGuard),
        ("testConditionWrapAutoForMultilineGuard", testConditionWrapAutoForMultilineGuard),
        ...
        ("testWrapConditionsAutoForLongIf", testWrapConditionsAutoForLongIf),
        ("testWrapConditionsAutoForLongMultilineIf", testWrapConditionsAutoForLongMultilineIf),
